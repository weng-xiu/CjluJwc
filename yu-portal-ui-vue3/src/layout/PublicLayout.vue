      ...
      <div class="container header-inner">
        ...
        <div class="header-right">
          <div class="utility-row">
            ...
            <span class="divider">|</span>
            <router-link to="/login" class="login-link"><el-icon><User /></el-icon> 登录</router-link>
        ...
        <div class="mobile-menu-btn" @click="mobileMenuOpen = !mobileMenuOpen">
          <el-icon size="24"><Close v-if="mobileMenuOpen" /><Expand v-else /></el-icon>
        </div>
      </div>
    </header>

    <!-- 移动端侧边菜单（Vue3 迁移：router-link 上 .native 修饰符移除） -->

<template>
  <div class="page-container">
    <el-card>
      <template #header><div class="card-header"><el-icon><View /></el-icon> 监考安排</div></template>
      <el-table v-loading="loading" :data="invigilationList" border stripe>
        ...
        <el-table-column label="监考类型" prop="invigilationType" width="100" align="center">
          <template #default="scope"><el-tag size="small">{{ scope.row.invigilationType === 'main' ? '主监考' : '副监考' }}</el-tag></template>
        </el-table-column>

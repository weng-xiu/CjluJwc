<template>
  <div class="public-home">
    ...
    <!-- 7. 快速通道（Vue3 迁移：字体图标类 → el-icon + 动态组件，图标名见 data） -->
...
export default {
  ...
  data() {
    return {
      ...
      // 图标已由 el-icon-* 字体类名换为 element-plus 组件名（main.js 已全局注册全部图标）
      quickLinks: [
        { name: '一周安排', icon: 'Calendar', url: '#' },
        { name: '办事大厅', icon: 'OfficeBuilding', url: '#' },
        { name: '信息公开', icon: 'Document', url: '#' },
        { name: '校友总会', icon: 'User', url: '#' },
        { name: '教育发展基金会', icon: 'Money', url: '#' },
        { name: '图书与档案馆', icon: 'Reading', url: '#' },
        { name: '校外访问', icon: 'Link', url: '#' },
        { name: '招标采购', icon: 'ShoppingCartFull', url: '#' },
        { name: '期刊中心', icon: 'Notebook', url: '#' },
        { name: '科发院', icon: 'Compass', url: '#' },
        { name: '继教学院', icon: 'School', url: '#' },
        { name: '新闻网', icon: 'Notification', url: '#' }
      ]
    }
  },
  created() {

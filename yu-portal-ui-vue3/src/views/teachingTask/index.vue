<template>
  <div class="page-container">
    <el-card>
      <template #header><div class="card-header"><el-icon><Notebook /></el-icon> 教学任务查询</div></template>
      <el-table v-loading="loading" :data="taskList" border stripe>
        ...
        <el-table-column label="操作" width="100" align="center" fixed="right">
          <!-- 迁移：type="text"（element-plus 已移除）→ link + type="primary" -->
          <template #default="scope"><el-button link type="primary" size="small" @click="viewSyllabus(scope.row)">查看大纲</el-button></template>
        </el-table-column>
      </el-table>

<template>
  <div class="page-container">
    <el-card>
      <template #header>
        <div class="card-header"><el-icon><Edit /></el-icon> 成绩录入</div>
      </template>
      ...
      <el-table v-loading="loading" :data="gradeList" border stripe ref="gradeTable">
        ...
        <el-table-column label="平时成绩" width="120" align="center">
          <template #default="scope"><el-input-number v-model="scope.row.regularScore" :min="0" :max="100" size="small" controls-position="right" style="width:100px" /></template>
        </el-table-column>
        <el-table-column label="期末成绩" width="120" align="center">
          <template #default="scope"><el-input-number v-model="scope.row.finalScore" :min="0" :max="100" size="small" controls-position="right" style="width:100px" /></template>
        </el-table-column>
        <el-table-column label="总评成绩" width="100" align="center" prop="totalScore" />
        <el-table-column label="操作" width="100" align="center" fixed="right">
          <template #default="scope"><el-button type="primary" size="small" @click="saveGrade(scope.row)">暂存</el-button></template>
        </el-table-column>
      </el-table>

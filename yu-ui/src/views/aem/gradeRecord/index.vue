  ...
  <div class="app-container">
    ...
    <el-dialog :title="title" :visible.sync="open" width="650px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="100px">
        ...
        <el-form-item label="平时成绩" prop="regularScore"><el-input-number v-model="form.regularScore" placeholder="请输入平时成绩" :min="0" :max="100" :precision="1" style="width:100%" /></el-form-item>
        <el-form-item label="考试成绩" prop="examScore"><el-input-number v-model="form.examScore" placeholder="请输入考试成绩" :min="0" :max="100" :precision="1" style="width:100%" /></el-form-item>

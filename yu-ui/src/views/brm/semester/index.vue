<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="所属学年" prop="academicYearId"><el-select v-model="queryParams.academicYearId" placeholder="请选择学年" clearable><el-option v-for="y in yearList" :key="y.yearId" :label="y.yearName" :value="y.yearId"/></el-select></el-form-item>
    ...
    <el-table v-loading="loading" :data="semesterList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="所属学年" align="center" prop="academicYearName" />
...
export default {
  ...
  data() { return { loading: true, ids: [], single: true, multiple: true, showSearch: true, total: 0, semesterList: [], yearList: [], title: "", open: false,
    queryParams: { pageNum: 1, pageSize: 10, semesterName: null, academicYearId: null, status: null },
  ...
  created() { this.getList(); this.loadYears() },
  methods: {

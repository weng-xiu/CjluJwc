    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['brm:roomtype:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['brm:roomtype:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listRoomtype, getRoomtype, delRoomtype, addRoomtype, updateRoomtype } from "@/api/brm/roomtype"
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      this.download('brm/roomtype/export', {
        ...this.queryParams

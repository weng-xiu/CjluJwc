...
public class AemSupervisionRecordController extends BaseController
{
    ...
    @PostMapping
    public AjaxResult add(@RequestBody AemSupervisionRecord aemSupervisionRecord)
    {
    ...
    @PutMapping
    public AjaxResult edit(@RequestBody AemSupervisionRecord aemSupervisionRecord)
    {

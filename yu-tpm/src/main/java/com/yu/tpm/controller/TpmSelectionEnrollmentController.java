...
public class TpmSelectionEnrollmentController extends BaseController
{
    ...
    @PostMapping
    public AjaxResult add(@RequestBody TpmSelectionEnrollment tpmSelectionEnrollment)
    {
    ...
    @PutMapping
    public AjaxResult edit(@RequestBody TpmSelectionEnrollment tpmSelectionEnrollment)
    {

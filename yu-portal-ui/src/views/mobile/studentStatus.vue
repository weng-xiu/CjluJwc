  ...
  <div class="mobile-status">
    ...
    <div class="apply-block">
      <div class="block-title">
        <span>异动申请</span>
        <el-button type="primary" size="mini" plain @click="toggleApply">{{ applyOpen ? '收起' : '发起申请' }}</el-button>
      </div>
    ...
    <div v-else-if="list.length === 0" class="empty-state"><i class="el-icon-folder-opened"></i><p>暂无异动申请</p></div>

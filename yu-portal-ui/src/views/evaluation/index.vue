<template>
  <div class="page-container">
    <el-card>
      <div slot="header" class="card-header"><i class="el-icon-star-on"></i> 评教入口</div>
      ...
      <el-table v-loading="loading" :data="questionnaireList" border stripe>
        ...
        <el-table-column label="状态" width="100" align="center">
          <template slot-scope="scope"><el-tag :type="scope.row.completed ? 'success' : 'info'" size="small">{{ scope.row.completed ? '已完成' : '待评教' }}</el-tag></template>
        </el-table-column>
    ...
    <!-- 评教对话框 -->
    <el-dialog title="教学评价" :visible.sync="dialogVisible" width="600px" :close-on-click-modal="false">
      ...
      <div slot="footer"><el-button @click="dialogVisible = false">取消</el-button><el-button type="primary" @click="submitEval">提交评教</el-button></div>
    </el-dialog>
  </div>
</template>
<script>
